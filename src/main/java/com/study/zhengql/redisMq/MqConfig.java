...
//    @Value("${mq.monitor.count}")
    private int monitorCount=30;
//    @Value("${mq.queue.first}")
    private String queueFirst="queue:1";
//    @Value("${mq.queue.second}")
    private String queueSecond="queue:2";
//    @Value("${mq.consumer.first}")
    private String listFirst="list:1";
//    @Value("${mq.consumer.second}")
    private String listSecond="list:2";
}
